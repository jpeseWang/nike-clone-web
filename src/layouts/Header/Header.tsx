        ...
        <nav className="header-navbar">
            <div className="header-navbar__first-layer">
                <ul className="header-navbar__list">
                  ...
                  <li className="header-navbar__list-item">Sign in</li>
                </ul>
            </div>

            <ul className="header-navbar__list-2">
                <li className="header-navbar__list-2__logo">
                    <img src="/img/nike_logo.jpeg" alt="" />
                </li>
                ...
                <li className="header-navbar__list-2__info">
                    ...
                    <span className="list-2__info-detail">Sales</span>
                    <span className="list-2__info-detail">SNKR</span>
                </li>

                <li className="header-navbar__list-2__icon">
                  <label htmlFor="" className="list-2__search-bar">
                      <input type="text" className="list-2__search-input"/>
