  ...
  return (
    <div className="grid home">
      ...
      <div className="home__luk-al">
        ...
        <p className="home__luk-al-text home__luk-al-text--strong home__luk-al-text--small">Luka 2</p>
        <h2 className="home__luk-al--title">"LUK.AI"</h2>
        <p className="home__luk-al-text">This edition is inspired by the revolutionary idea of Luka’s virtual counterpart,</p>
        <p className="home__luk-al-text">Luk.AI.</p>
        <p className="home__luk-al-text">Colors match Luk.AI’s outfit in the digital world while glow-in-the-dark elements</p>
        <p className="home__luk-al-text">keep the look sleek no matter what realm you’re stepping out in.</p>
        <a href="" className="home__luk-al__arround bordered__shop">Shop</a>
      </div>
      <div className="product">
        <div className="product__cover">
          ...
          <div className="product__navigation">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="product__navigation__arrow">
          ...
          <div className="product__shoes">
              <div className="product__shoes-each">
                  <img src={jordan__mid} alt="" className="product__shoes-each__img"/>
          ...
          <div className="slider"> 
            ...
            <div className="slider__info">
                ...
                <p className="slider__details">The Jordan MVP collection has arrived with new rendition of timeless classic. Premium in all the right way these pieces combine a comfortable feel with eye-catching colors.</p>
                <a href="" className="slider__shop bordered__shop">SHOP</a>
            </div>
          ...
          <div className="slider"> 
            ...
            <div className="slider__info">
                ...
                <p className="slider__details">Defy gravity in pieces that are made to move as effortlessly as you do</p>
                <a href="" className="slider__shop bordered__shop">SHOP</a>
            </div>
